package __AS3__.vec
{
    ...
    final dynamic class Vector$double extends Object {
        ...
        function indexOf(value:Number, from:Number = 0) : Number {
        ...
        function slice(start:Number = 0, end:Number = 2147483647) : Vector$double {
        ...
        function sort(comparefn) : Vector$double {
        ...
        function lastIndexOf(value:Number, from:Number = 2147483647) : Number {
            var _loc_3:* = this.clamp(from, this.length);
        ...
        function filter(checker:Function, thisObj:Object = null) : Vector$double {
        ...
        function splice(start:Number, deleteCount:Number, ... args) : Vector$double {
