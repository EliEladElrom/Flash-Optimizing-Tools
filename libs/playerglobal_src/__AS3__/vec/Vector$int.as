package __AS3__.vec
{
    ...
    final dynamic class Vector$int extends Object {
        ...
        function indexOf(value:int, from:Number = 0) : Number {
        ...
        function slice(start:Number = 0, end:Number = 2147483647) : Vector$int {
        ...
        function sort(comparefn) : Vector$int {
        ...
        function lastIndexOf(value:int, from:Number = 2147483647) : Number {
            var _loc_3:* = this.clamp(from, this.length);
        ...
        function filter(checker:Function, thisObj:Object = null) : Vector$int {
        ...
        function splice(start:Number, deleteCount:Number, ... args) : Vector$int {
