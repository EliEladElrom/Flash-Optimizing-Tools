package __AS3__.vec
{
    ...
    final dynamic class Vector$uint extends Object {
        ...
        function indexOf(value:uint, from:Number = 0) : Number {
        ...
        function slice(start:Number = 0, end:Number = 2147483647) : Vector$uint {
        ...
        function sort(comparefn) : Vector$uint {
        ...
        function lastIndexOf(value:uint, from:Number = 2147483647) : Number {
            var _loc_3:* = this.clamp(from, this.length);
        ...
        function filter(checker:Function, thisObj:Object = null) : Vector$uint {
        ...
        function splice(start:Number, deleteCount:Number, ... args) : Vector$uint {
