package ca.newcommerce.googlecontacts.webservice 
{
	...
	*/
	public class GContactsClient extends EventDispatcher
	{
		...
		protected function callProxy(responder:Responder, url:String, method:String, getVars:Array, postVars:Array, headers:Array, id:Number):void
		{
		...
		public function getContacts():Number
		{
		...
		protected function doContacts(result:Object):void
		{
			...
			trace("doContacts, content:" + content);
		}
